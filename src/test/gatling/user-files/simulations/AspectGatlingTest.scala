...
/**
 * Performance test for the Aspect entity.
 */
class AspectGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Aspect entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created aspect")
                .get("${new_aspect_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created aspect")
            .delete("${new_aspect_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
