...
class PersonGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Person entity")
        ...
        .repeat(2) {
            ...
            .post("/api/people")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "guid":"SAMPLE_TEXT", "diasporaId":"SAMPLE_TEXT", "serializedPublicKey":"SAMPLE_TEXT", "createdAt":"2020-01-01T00:00:00.000Z", "updatedAt":"2020-01-01T00:00:00.000Z", "closedAccount":null, "fetchStatus":"0", "podId":"0"}""")).asJSON
            .check(status.is(201))
