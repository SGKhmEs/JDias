...
/**
 * Performance test for the StatusMessage entity.
 */
class StatusMessageGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the StatusMessage entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all statusMessages")
