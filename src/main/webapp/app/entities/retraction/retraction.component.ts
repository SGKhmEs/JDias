...
export class RetractionComponent implements OnInit, OnDestroy {
    ...
    registerChangeInRetractions() {
        this.eventSubscriber = this.eventManager.subscribe('retractionListModification', (response) => this.reset());
    }
