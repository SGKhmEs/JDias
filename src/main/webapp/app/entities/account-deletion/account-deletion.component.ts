...
export class AccountDeletionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        ...
        this.accountDeletionService.query({
            page: this.page,
            size: this.itemsPerPage,
            sort: this.sort()
        }).subscribe(
    ...
    registerChangeInAccountDeletions() {
        this.eventSubscriber = this.eventManager.subscribe('accountDeletionListModification', (response) => this.reset());
    }
    ...
    private onSuccess(data, headers) {
        ...
        for (let i = 0; i < data.length; i++) {
            this.accountDeletions.push(data[i]);
        }
    }
