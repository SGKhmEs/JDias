...
export class EventParticipationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        ...
        this.eventParticipationService.query({
            page: this.page,
            size: this.itemsPerPage,
            sort: this.sort()
        }).subscribe(
    ...
    registerChangeInEventParticipations() {
        this.eventSubscriber = this.eventManager.subscribe('eventParticipationListModification', (response) => this.reset());
    }
    ...
    private onSuccess(data, headers) {
        ...
        for (let i = 0; i < data.length; i++) {
            this.eventParticipations.push(data[i]);
        }
    }
